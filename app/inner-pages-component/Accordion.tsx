                        ...
                        <div key={item.id} className='border border-[#B4FE5D]/30 rounded-lg overflow-hidden'>
                            <button onClick={() => toggleItem(index)}
                                ...
                                <span className='ml-2'>
                                    {activeIndex === index ? (
                                    // Minus icon SVG
                                        <svg width={26} height={26} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_221_641)">
                                            ...
                                            </g><defs> <clipPath id="clip0_221_641"> <rect width={26} height={26} fill="white"transform="translate(0 26) rotate(-90)"/></clipPath></defs>
                                        </svg>
                                        ) : (
                                        // Plus icon SVG
                                        <svg width={26} height={26} viewBox="0 0 26 26"fill="none"xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_221_665)">
                                            <path d="M14.0145 20.2228L25.5846 8.65251C25.8525 8.3849 26 8.02767 26 7.64676C26 7.26585 25.8525 6.90862 25.5846 6.64101L24.7328 5.78894C24.1777 5.23449 23.2755 5.23449 22.7213 5.78894L13.0054 15.5048L3.27872 5.77816C3.0109 5.51055 2.65388 5.36279 2.27318 5.36279C1.89207 5.36279 1.53504 5.51055 1.26701 5.77816L0.415362 6.63023C0.147544 6.89805 1.05378e-06 7.25507 1.03713e-06 7.63598C1.02048e-06 8.01689 0.147544 8.37412 0.415362 8.64173L11.996 20.2228C12.2647 20.4911 12.6234 20.6384 13.0048 20.6376C13.3876 20.6384 13.7461 20.4911 14.0145 20.2228Z"fill="#B5FF5F"/></g><defs><clipPath id="clip0_221_665"><rect width={26} height={26} fill="white"transform="translate(26 1.1365e-06) rotate(90)"/></clipPath></defs>
                                        </svg>
                                        )}
                                </span>
                            </button>
