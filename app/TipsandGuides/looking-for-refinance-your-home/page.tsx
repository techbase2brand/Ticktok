  ...
  return (
    <>
        <Banner
            ...
            description="Go through the guide in your own time and contact us for more information or to make an appointment at a time that suits you."
            imageUrl="/is-your-home.webp"
        />
