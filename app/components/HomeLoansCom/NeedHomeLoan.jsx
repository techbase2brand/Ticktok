        ...
        <div className='flex flex-col md:flex-row items-center justify-between px-6 sm:px-10 md:px-14 py-10 md:py-12 gap-6 md:gap-0'>
          ...
          {(heading || description || buttonText) && (
            <div className='w-full md:w-1/2 flex flex-col items-start gap-4 md:gap-5'>
              ...
              {buttonText && (
                <a href='#' className='cursor-pointer bg-transparent border border-[#B5FF5F] text-[#B5FF5F] px-5 py-2.5 sm:px-6 sm:py-3 rounded-full font-semibold hover:bg-[#B5FF5F] hover:text-[#154617] hover:border-[#B5FF5F] transition-all duration-300 flex items-center gap-2 text-sm'>
