...
const Hero = ({ subheading, heading, description, badge, apply, checkEligibility }) => {
    const badgeSvg = (
    ...
    return (
        <div className='banner w-full relative min-h-[700px] md:min-h-[700px] flex items-center pb-[30px] overflow-hidden'>
            ...
            >
                <source src="/0_Couple_Home_1920x1010.mp4" type="video/mp4" />
            </video>
            
            {/* Dark Overlay - Multiple layers for better effect */}
