...
type WhyTiktockProps = {
  title?: string;
  description?: string;
  descriiption2?: string;
};
const WhyTiktock = ({ title, description, descriiption2 }: WhyTiktockProps) => {
    const boxData = [
        {
            svg: (
            ...
            description: "We work with a wide panel of lenders — banks, credit unions, and specialist lenders — to find a loan that fits  your situation, not just whatever one bank is offering today."
        },
        {
            svg: (
                <svg width={34} height={34} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "Expert Advice, Plain Language",
            description: "No jargon. No confusion. Just clear, honest guidance from brokers who genuinely care about getting you the best outcome — whether you're buying your first home, investing, or refinancing."
        },
        {
            svg: (
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "Fast, Efficient & Hassle-Free",
            description: "Time is money. That's why we streamline the entire process from application to approval, keeping you informed every step of the way so there are no surprises."
        },
        {
            svg: (
                <svg width={34} height={34} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            description: "Our service is completely free to you. We're paid by the lender when your loan settles — so you get expert mortgage advice without the price tag."
        },
            {
            svg: (
                <svg width={34} height={34} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "We're in Your Corner — Long Term",
            description: "Our relationship doesn't end at settlement. We'll check in regularly, review your loan as the market changes, and make sure your mortgage keeps working as hard as you do."
        },
            {
            svg: (
                <svg width={34} height={34} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            title: "Local Knowledge, Broader Reach",
            description: "We understand the local market and the people in it. Combined with access to lenders across Australia, we bring you the best of both worlds."
        },
    ];
        ...
        <div className='why-tiktock-section bg-gradient-to-r from-[#000000] via-[#0b110c] to-[#0b110c] py-8 md:py-[50px] px-4 sm:px-6 lg:px-8'>
            <div className='max-w-[1440px] mx-auto'>
               ...
               <h2  data-aos="fade-up"  data-aos-duration="500" className='text-3xl sm:text-4xl md:text-[45px] font-bold text-center pb-2 md:pb-4 leading-tight'>
                ...
                <p className='text-center text-[#ddd] text-sm sm:text-base md:text-lg max-w-4xl mx-auto px-4'>{descriiption2}</p>
                
                {/* Box Wrapper - Responsive grid */}
                <div className='box-wrapper grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8 pt-8 md:pt-[40px]'>
