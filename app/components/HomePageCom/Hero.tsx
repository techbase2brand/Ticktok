                            ...
                            <div data-aos="fade-up" data-aos-duration="800" 
                                ...
                                {hasContent(apply) && (
                                    <Link href={applyUrl} title='Apply Now' aria-label='Apply Now' 
                                        className='cursor-pointer bg-[#B5FF5F] flex items-center justify-center gap-[10px] text-[#154617] px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-bold hover:bg-white transition-colors duration-300 text-sm sm:text-base w-full sm:w-auto shadow-[0_8px_20px_rgba(181,255,95,0.3)] hover:shadow-[0_8px_25px_rgba(181,255,95,0.5)]'>
                                        {apply} {arrowSvg}
                                    </Link>
                                )}
